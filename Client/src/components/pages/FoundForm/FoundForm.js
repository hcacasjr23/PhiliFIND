...
function FoundForm() {
	...
	const API_PATH =
		'http://localhost/PhiliFIND/Client/src/api/PostData/found.php';
		...
		<form>
			<div className='found-form'>
									...
									<Grid item={true} xs={12}>
										<StyledFormControl fullWidth>
											...
											>
												...
												<MenuItem value={'Electronic Gadget'}>
													Electronic Gadget
												</MenuItem>
												<MenuItem value={'Personal Accessory'}>
													Personal Accessory
												</MenuItem>
											</Select>
										</StyledFormControl>
				...
				<div className='middle wrapper'>
					<Container>
						<div className='section-header'>
							<div className='section-header-wrapper'>Found Item Location</div>
						</div>
						<br />
						...
						<Grid container spacing={2} direction='row'>
							...
							<Grid item={true} xs={12}>
								<div className='google-map-wrapper'>
									<Maps setMapAddress={setMapAddress} />
								</div>
							</Grid>
